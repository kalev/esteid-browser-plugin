...
PinInput::PinInput(PinType pinType, const std::string& name)
...
void PinInput::setText(std::string text)
{
    std::string tmp;
    tmp = "<big>";
    tmp += text;
...
std::string PinInput::getPin()
{
    return m_entry.get_text();
}

void PinInput::setMinPinLength(int len)
{
    m_minPinLength = len;
}

void PinInput::on_button_more_info_clicked()
{
    std::cout << "More Info clicked." << std::endl;
}

void PinInput::on_button_cancel_clicked()
{
    std::cout << "Cancel clicked." << std::endl;
    response(Gtk::RESPONSE_CANCEL);
}

void PinInput::on_button_ok_clicked()
{
    std::cout << "OK clicked." << std::endl;
    response(Gtk::RESPONSE_OK);
}

void PinInput::on_pin_changed()
{
